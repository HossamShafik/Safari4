      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              DropdownButton<String>(
                ...
                items: <String>['Single', 'Double', 'Triple', 'Quad']
          ...
          Slider(
            ...
            inactiveColor: deepPurple.withOpacity(0.3),
          ...
          Text(
            currentSliderValue.toString() + " Person",
            style: TextStyle(fontWeight: FontWeight.w600),
          ),
          SizedBox(
            width: MediaQuery.of(context).size.width,
                ...
                children: [
                  Text(
                    TotalPrice(
                        ...
                        " L.E ",
                    style: TextStyle(
                        fontSize: 18, fontWeight: FontWeight.w600, color: pink),
                  ),
                  Text(
                    "Total Price",
                    style: TextStyle(
